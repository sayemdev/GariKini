...
public class HeavyBodyTypeAdapter extends RecyclerView.Adapter<HeavyBodyTypeAdapter.ViewHolder> {

    List<ChooseSellOptionModel>sellOptionModels;
    Context context;
    Listener listener;

    public HeavyBodyTypeAdapter(List<ChooseSellOptionModel> sellOptionModels, Context context, Listener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.heavy_body_type,parent,false));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imageView=itemView.findViewById(R.id.bodyTypeIcon);
        }
    }
